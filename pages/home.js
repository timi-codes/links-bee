        ...
        <Box as={Flex}>
          ...
          <Menu justifySelf="center">
            <MenuButton
              ...
              <Avatar name="Tejumola David" src="https://bit.ly/sage-adebayok" size="md" showBorder border="4px solid white"/>
            </MenuButton>
            <MenuList>
      ...
      <Flex direction="column">
        <Box as={Grid} maxWidth="1050px" backgroundColor="white" margin="0 auto" height="70vh" gridTemplateColumns="340px 1fr">
          <Box height="100%" backgroundColor="#F6F6F6">
            ...
            >
              {
                links.map((link, index) => <LongTimeLinkItem value={link.shortenedLink} link={link}/>)
              }
            </RadioButtonGroup>
          </Box>
          <DetailView/>
