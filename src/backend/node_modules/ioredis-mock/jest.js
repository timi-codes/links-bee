  ...
  function connectHandler(self2) {
    return function() {
      ...
      if (self2.condition.select) {
        self2.select(self2.condition.select);
      }
  ...
  var SentinelConnector = class extends AbstractConnector_1.default {
    ...
    resolveMaster(client, callback) {
      client.sentinel("get-master-addr-by-name", this.options.name, (err, result) => {
        ...
        this.updateSentinels(client, (err2) => {
          client.disconnect();
          if (err2) {
...
var require_built = __commonJS((exports2, module2) => {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {value: true});
...
var makeReturnValue = (L) => {
  ...
  if (!isArray2) {
    return import_fengari_interop.default.tojs(L, -1);
  }
...
function keys(globString) {
  return this.data.keys().filter((key) => (0, import_minimatch.default)(key, globString));
}
...
function subscribeToChannel(instance, chan, channels, isPattern) {
  ...
  const listener = (message, channel) => emitMessage(instance, isPattern ? channel : chan, message);
...
var import_minimatch2 = __toModule(require("minimatch"));
function publish(channel, message) {
  this.channels.emit(channel, message);
  const matchingPatterns = this.patternChannels.eventNames().filter((pattern2) => (0, import_minimatch2.default)(channel, pattern2));
